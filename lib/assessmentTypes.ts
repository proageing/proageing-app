...
export const ASSESSMENT_TYPES: { type: AssessmentType; step: number; title: string }[] = [
  { type: "purpose", step: 1, title: "Sense of Purpose" },
  { type: "family-history", step: 2, title: "Family History" },
  ...
  { type: "nutrition-protein", step: 5, title: "Nutrition & Protein" },
