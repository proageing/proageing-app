...
export const PROGRAM21_DAYS_ZH: Program21Day[] = [
  ...
  },
  {
    ...
    pillar: "步骤 3 — 坚持日常运动",
    learn:
      "中等强度——也就是第二心率区间——是走路对心肺帮助最大的地方，而且它比一般人想的更容易达到：快到会喘一点，但慢到还能和人聊天。",
    assessments: [{ label: "找出你的训练心率区间", href: "/assess/training-zone" }],
  ...
  },
  {
    ...
    pillar: "运动",
    learn:
      "60 到 80 岁的成年人，只要持续训练 3 到 6 个月，最大摄氧量可以提升 15% 到 25%——你现在走的每一步，都在往那里累积。走了两周，正好可以测一个基准值。",
    assessments: [{ label: "做你的最大摄氧量与静息心率检测", href: "/assess/vo2max" }],
    action: "今天继续保持你的走路连续记录，并测出你的最大摄氧量基准值。",
