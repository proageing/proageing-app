...
export const en = {
  ...
  howTo: {
    ...
    "band-row": {
      name: "Towel row",
      whatIs: "Pulling against a bath towel — this works the muscles across your upper back that hold your posture up. No equipment to buy.",
      steps: [
        "Sit with your legs out in front and loop the bath towel around your feet, or anchor it to something sturdy at chest height.",
        "Hold both ends so there's no tension in the towel.",
        "Pull your elbows back and close to your body.",
        "Keep your back straight.",
        "Pull and hold for 20-30 seconds.",
        "Remember to breathe. 🙂",
      ],
      easier: "Pull more gently, and hold for 10 seconds instead of 20. Bend your knees a little if sitting with straight legs is uncomfortable.",
      stopIf: "you feel a pinch in your shoulder or neck rather than effort across your back, or you find yourself holding your breath.",
    },
    "one-leg-stand": {
    ...
    "protein-breakfast": {
      name: "Getting 25–40g of protein at breakfast",
      whatIs: "25g is about a palm-sized piece of fish or meat. Most local breakfasts land nearer 5–10g, which is the gap this day is about closing.",
      steps: [
        "Pick one main protein — eggs, fish, tau kwa, or yoghurt.",
        "Check it against the list below. If it comes to less than 25g, add one more item.",
        "Two eggs plus one other item gets almost anyone over 25g.",
        "Eat it at breakfast, not saved for dinner — spreading protein across the day works better than one big evening serving.",
      ],
      portions: [
        { food: "2 half-boiled eggs", protein: "13g" },
        { food: "Fish soup (sliced fish)", protein: "25g" },
        { food: "Tau kwa, 1 piece", protein: "12g" },
        { food: "Greek yoghurt, small tub", protein: "15g" },
        { food: "Unsweetened soya milk, 1 glass", protein: "7g" },
        { food: "Wholemeal bread, 2 slices", protein: "8g" },
        { food: "Peanuts, small handful", protein: "7g" },
        { food: "Tau huay (soft beancurd), 1 bowl", protein: "6g" },
      ],
      easier: "Two eggs added to what you already eat is the single easiest change — about 13g, no new recipe, available at every kopitiam.",
    },
    "hawker-protein": {
      name: "What to order at the hawker centre",
      whatIs: "You don't need to cook differently to eat more protein — you need to order differently. These are ordinary stalls, ordered slightly better.",
      steps: [
        "Say the order out loud as written below — the change is usually one phrase.",
        "\"Less rice\" and \"add egg\" are understood at almost every stall.",
        "Pick the soup or steamed version over the fried one where there's a choice.",
      ],
      portions: [
        ...
        { food: "Thunder tea rice (lei cha)", protein: "20g" },
        { food: "Thosai + dhal + egg", protein: "20g" },
        { food: "Wanton noodle soup + extra wanton", protein: "22g" },
      ],
      easier: "If you remember nothing else: add an egg (+7g) and ask for less rice. That alone moves most hawker meals into range.",
    },
  ...
  assess: {
    ...
    proteinCalculator: {
      eyebrow: "Protein Calculator · ~2 minutes",
      ...
      intro2: "Two questions, then a list you can tap as you eat.",
      begin: "Let's begin",
      aboutYou: "About you",
      yourWeight: "Your weight",
      kgUnit: "kg",
      strengthQuestion: "Do you do strength exercise twice a week or more?",
      strengthYes: "Yes",
      strengthNo: "No",
      strengthNote: "Strength work raises how much protein you can use, so it raises the target.",
      calculate: "Work out my target",
      yourTarget: "Your daily target",
      gramsADay: "grams of protein a day",
      perMealLabel: (grams: number) => `About ${grams}g per meal, across three meals`,
      palmNote: "25g is roughly a palm-sized piece of fish, chicken or tofu.",
      tallyHeading: "What have you eaten today?",
      tallyBlurb: "Tap an item each time you eat it. The total updates as you go.",
      everyday: "Everyday foods",
      hawker: "Hawker meals",
      totalSoFar: "Today's total",
      remaining: (grams: number) => `${grams}g to go`,
      targetMet: "Target reached — nicely done.",
      yourOwn: "Your own items",
      addHeading: "Ate something not on the list?",
      addHint: "Add it yourself. If you are not sure how much protein it has, a palm-sized piece of fish, chicken or tofu is about 25g, and a glass of milk is about 8g.",
      customNameLabel: "What was it?",
      customNamePlaceholder: "Protein shake",
      customGramsLabel: "Protein in grams",
      addButton: "Add to my list",
      remove: "Remove",
      customFallbackName: "Something else",
      clearTally: "Start today again",
      changeAnswers: "Change my weight",
      done: "Done",
      kidneyWarning:
      ...
      sources:
        "Targets follow PROT-AGE (Bauer et al., 2013) and ESPEN (Deutz et al., 2014) for healthy older adults.",
      foods: {
        egg: "Egg",
        tauKwa: "Tau kwa, 1 piece",
        softTofu: "Soft tofu, 1 block",
        greekYoghurt: "Greek yoghurt, small tub",
        milk: "Milk, 1 glass",
        soyaMilk: "Unsweetened soya milk, 1 glass",
        peanuts: "Peanuts, small handful",
        wholemealBread: "Wholemeal bread, 2 slices",
        fishPalm: "Fish, palm-sized",
        ...
        leiCha: "Thunder tea rice (lei cha)",
        thosaiDhal: "Thosai + dhal + egg",
        wantonMee: "Wanton noodle soup",
      },
    },
    trainingZone: {
