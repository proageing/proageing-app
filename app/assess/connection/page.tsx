...
export default function ConnectionPage() {
  ...
  return (
    <main className="mx-auto max-w-xl px-6 py-12">
      {screen === "welcome" && (
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-primary-dark">Connection Check · ~3 minutes</p>
          <h1 className="mt-1 text-2xl font-semibold text-neutral-900">Connection Check</h1>
      ...
      {screen === "questions" && (
        <div>
          <h2 className="text-xl font-semibold text-neutral-900">Your family, friends, and feelings</h2>
          <p className="mt-1 text-sm text-neutral-500">There are no right or wrong answers — just answer as accurately as you can.</p>
      ...
      {screen === "results" && (
        <div>
          ...
          <div className="mt-2 text-center">
            <div className="text-5xl font-bold text-primary-dark">{score.loneliness}</div>
            <div className="text-sm font-medium text-neutral-500">loneliness score (UCLA-3) · lower means less lonely</div>
          </div>
          ...
          <div className="mt-2 flex flex-col gap-2">
            <div className="flex items-center justify-between rounded-lg border border-neutral-200 px-4 py-2 text-sm">
              <span className="font-medium text-neutral-800">Family network ({score.family}/15)</span>
            ...
            <div className="flex items-center justify-between rounded-lg border border-neutral-200 px-4 py-2 text-sm">
              <span className="font-medium text-neutral-800">Friend network ({score.friends}/15)</span>
